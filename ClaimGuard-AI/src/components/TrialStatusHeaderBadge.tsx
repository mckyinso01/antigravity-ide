...
export const TrialStatusHeaderBadge: React.FC<TrialStatusHeaderBadgeProps> = ({
  ...
  if (isUnlockedPerpetual) {
    return (
      <SmartTooltip
        ...
        content="100% Perpetual On-Premises IP License Active. Zero recurring per-claim SaaS taxes."
      >
  ...
  return (
    <SmartTooltip
      ...
      content="Full-featured sovereign claims defense trial active. Click to review trial status, request custom legal briefs, or unlock perpetual license."
    >
      <button
        type="button"
