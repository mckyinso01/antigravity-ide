...
![](https://github.com/kroperuk/vscode-github-actions/raw/HEAD/media/header.png)
...
![View workflow runs and logs](https://github.com/kroperuk/vscode-github-actions/raw/HEAD/media/workflows.png)
...
![Syntax highlighting](https://github.com/kroperuk/vscode-github-actions/raw/HEAD/media/highlight.png)

**Integrated documentation** for the workflow schema, expression functions, and even event payloads:

![Tooltip showing description for a pull_request payload](https://github.com/kroperuk/vscode-github-actions/raw/HEAD/media/docs.png)
...
![Validation for YAML keys and expressions](https://github.com/kroperuk/vscode-github-actions/raw/HEAD/media/validation.png)
...
![Video showing workflow validation and auto-completion](https://github.com/kroperuk/vscode-github-actions/raw/HEAD/media/authoring.gif)
...
See [CONTRIBUTING.md](https://github.com/kroperuk/vscode-github-actions/blob/HEAD/CONTRIBUTING.md). A description of the architecture of the extension can be found [here](https://github.com/kroperuk/vscode-github-actions/blob/HEAD/docs/project-architecture.md).

## License

This project is licensed under the terms of the MIT open source license. Please refer to [MIT](https://github.com/kroperuk/vscode-github-actions/blob/HEAD/LICENSE) for the full terms.
