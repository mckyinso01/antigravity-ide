 ...
 */
import { type MCPServerConfig, type TelemetrySettings } from '@google/gemini-cli-core';
 ...
 * settings.json).
 */
export declare function loadSettings(workspaceDir: string, isTrustedOverride?: boolean): Settings;
