...
function isAgentSettings(value) {
...
function isPersistedStateMetadata(value) {
    return (typeof value === 'object' &&
        value !== null &&
...
export function getContextIdFromMetadata(metadata) {
    if (!metadata) {
        return undefined;
    }
...
export function getAgentSettingsFromMetadata(metadata) {
    if (!metadata) {
        return undefined;
    }
...
// SIG // eBZbx6eOF+9U56EDbqwzGoh27DhKcZUQmT62yL3y1TWg
...
// SIG // 9w0BCQQxIgQgiJOOE5iG94hBr305BnLq0W0pItuY1Roy
// SIG // /BhbtEpUkQIwDQYJKoZIhvcNAQEBBQAEggIAPPuqjoCI
// SIG // VNCRehwkoImcsYggAezeZbBiecWvx45/d0olGbE+J6Qo
// SIG // 6xnpq7iTXYzvehjTSM7WOwVePX6Mqu2dC/kZ2miLupB5
// SIG // akJB3+bYmkUFbjNxOtM3TWuy3hwfVRSFMvKqg3edKTI8
// SIG // ChfGydySuavLmszG7OqPPPhYZSaB+tfSfOMLkAteVaTI
// SIG // Qi0bTh/2EPffMP9+rz+gIRvPISK776ehXh5bnlKui6A2
// SIG // YXG3lnlwQh1ovCgsHLrkPHDkC+pW6MPx+txVchF2w3vV
// SIG // 6bwv0h19EvxD6T52vPpJ5j2SxzmhREqikNOQdoDrDZ05
// SIG // l8q7x4LDQ/gu2Mm408AHGWEIi1V0YDfSkTf6SFwCkDs+
// SIG // sz/TlK4h9p2n5q+8h6Zh305InKaxdGdai4cyetCwX+GQ
// SIG // gyzXeaD68GRHn+TwrMBPEXcj7dTMPhBTbxD3cFgy84oF
// SIG // DjlIKvT86L3rzNMHPL8BYXb+n80e2B/g/tZ0jhHa6YBQ
// SIG // hzKSyvX9QRpcYQcpxleLLcocQfMUqxoz2FpuH641vy3l
// SIG // gZWElfsBo+5Y4vibZ/MMpI8g939+imgX6jV11jVeXd2e
// SIG // masCsoCSg/FfibzQDu7NPg9bVggpc9hNJWhyxjJH7/Xw
// SIG // QqRunHpOD4MPMWElQjWR/7M4guDdz/IO7GtMDQVaZ1nS
// SIG // FmM4sx5dRlvzTUChghd2MIIXcgYKKwYBBAGCNwMDATGC
...
// SIG // Hlmh/bk0t733WKJ3la0pcLlz9gI9fghk/2SBgA9TbBoC
// SIG // ED7v+VE1B0k7KpJEJ1qzo/MYDzIwMjYwNzA4MTgyNjA3
...
// SIG // MAf7QX4wLwYJKoZIhvcNAQkEMSIEIDi6az2twCbkZTd0
// SIG // 3lMTS07zEZWrscn+uEr95r+MHGxFMDcGCyqGSIb3DQEJ
// SIG // EAIvMSgwJjAkMCIEIEqgP6Is11yExVyTj4KOZ2ucrsqz
// SIG // P+NtJpqjNPFGEQozMA0GCSqGSIb3DQEBAQUABIICAGoB
// SIG // F6oIOBOYKq29yR6s2UvsA/5OHZlO3j0HMnFYNL8+3Bq+
// SIG // /6Z0yfyvoaVjXOyuJjXZ6BcFlaCmpJDKaHr3BfYik0Dl
// SIG // 3vuWgtcKM3ybadr72bYYrLIYYB9x417vbMfxeUVXVPkc
// SIG // nt/POOHXd0XCKzVZdOlWP30k2qQRCXHLIuNQoIF+aZTG
// SIG // lF4NHaqu0BWzsZhyqzQVjwOSJTL8YVJ8qLm/KS1mccp2
// SIG // Ht61IcKA9sCZfknUMG774Z7p6pclWO02tmsAYhKKPfxn
// SIG // LBqSI2FbG3qIkKKiAqxQdQgYeUwbVPBkyAc7+F5+D6e/
// SIG // 9l6AtflahtDJuvlB9eoajrwXTSMgpgs8O+SOukCKVJdh
// SIG // LJIjaf3uSU4dEdMP0byunXYUKTm4srvTolX05E2qfCGb
// SIG // 7mP2G/mpGDyBoTyQErF5fGaC8hEgx4yU0Cxyb9X1jka8
// SIG // 6l8UGkhqF89lz4gV9iapvrEJCMDaMJQnrKrhfTgcQ5kC
// SIG // N874X16KVEu1Ovx0BvrVrOD4gCxOkKkCdS4O/M1XNQir
// SIG // 3fbaObDyhDEmK86WbFOiq9txRPemgprmhAuAiyAqI0Sg
// SIG // jiAOd4xT+nxtCkefZC2L0/plPJOglXgUT1eqX78HhOLT
// SIG // FeWC5dnxJYWJGoY5QPLoGYBAagCFY5WPoZLeCH0XNI/g
// SIG // M5AZBCNAH27rrUo4Klwp
