...
import { GeminiEventType, MessageBusType, } from '@google/gemini-cli-core';
...
describe('Task', () => {
    ...
    describe('acceptAgentMessage', () => {
        ...
        it('should capture usageMetadata on Finished event and include it in final status update', async () => {
            ...
            task.setTaskStateAndPublishUpdate('input-required', { kind: CoderAgentEvent.StateChangeEvent }, undefined, undefined, true);
            expect(mockEventBus.publish).toHaveBeenCalledWith(expect.objectContaining({
                final: true,
                metadata: expect.objectContaining({
                    usageMetadata: {
    ...
    describe('Race Condition Fix', () => {
        ...
        it('handleEventDrivenToolCallsUpdate should ignore events for other schedulers', async () => {
            // @ts-expect-error - Calling private constructor
            const task = new Task('task-id', 'context-id', mockConfig, mockEventBus);
            const handleEventDrivenToolCallSpy = vi.spyOn(task, 'handleEventDrivenToolCall');
            const otherEvent = {
                type: MessageBusType.TOOL_CALLS_UPDATE,
                toolCalls: [
                    { request: { callId: '1' }, status: 'executing' },
                ],
    ...
    describe('Serialization and Mapping', () => {
        it('should map internal "validating" status to "scheduled" for the client and include outcome', async () => {
            ...
            const message = task['toolStatusMessage'](mockToolCall, 'task-id', 'context-id');
            const serialized = message.parts[0].data;
        ...
        it('should correctly detect changes when status or outcome changes', async () => {
            ...
            const changed1 = task['handleEventDrivenToolCall'](toolCall1);
            expect(changed1).toBe(true);
            // Second update with same status - should NOT trigger change
            const changed2 = task['handleEventDrivenToolCall'](toolCall1);
            ...
            const changed3 = task['handleEventDrivenToolCall'](toolCall2);
...
// SIG // CyFzW4KYMQkCtz2F+h7/yvIz3X08/8k1zvPW4Q2ePH2g
...
// SIG // 9w0BCQQxIgQgRwqu9hX+v+D9uitAu8MgNJCOb+c1h4mF
// SIG // o8wieaPjd80wDQYJKoZIhvcNAQEBBQAEggIAKhyWv44h
// SIG // X9OhbfqwF5/IGWybPe62f0XBCsY9x90/fJ00lITa6Ema
// SIG // cGk6230Ga4wYegqs3TWdz03iEgiJxlzBsWPpq7VvPUu/
// SIG // VIcPhme0aRCDCQdLnRuO1u8mggX0GvRhU+V1DEfv4MRd
// SIG // EL/vLqn2EirjjsLaXXECBrJdWUgq2A6dAvXDEFgk77Nz
// SIG // a0Na/w6WVXaXUVsgP8tmcPIaYEL299QIXNWXoTeN8Okd
// SIG // YepMIT/hFF3aoTIRDbXIpweOUQlLooRs0ci0VyPDPgD3
// SIG // aBwDDyoDkkPJrIoOiQgQTQrSdWD78qa3ZV/aYg52F/YG
// SIG // VspdsvDrsGi6waZE2KxnGoq/Z2Ux8E0BPADiJkob+rxq
// SIG // XumG+hwzXQrqJYxWUc+QFzQoNwvE7CPqj373KKdV+mWj
