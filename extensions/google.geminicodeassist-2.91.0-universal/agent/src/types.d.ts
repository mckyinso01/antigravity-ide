...
export declare function getContextIdFromMetadata(metadata: PersistedTaskMetadata | undefined): string | undefined;
export declare function getAgentSettingsFromMetadata(metadata: PersistedTaskMetadata | undefined): AgentSettings | undefined;
