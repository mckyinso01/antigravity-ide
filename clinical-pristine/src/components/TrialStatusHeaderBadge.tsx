...
export const TrialStatusHeaderBadge: React.FC<TrialStatusHeaderBadgeProps> = ({
  ...
  if (isUnlockedPerpetual) {
    return (
      <SmartTooltip
        ...
        content="100% Perpetual On-Premises IP License Active. Zero recurring per-bed SaaS taxes."
      >
  ...
  return (
    <SmartTooltip
      ...
      content="Full-featured sovereign hospital trial active. Click to review trial status, request custom modifications, or unlock perpetual license."
    >
      <button
        type="button"
